...
Option Explicit
Private start_row As Integer
Private end_row As Integer
Private MA(2) As Integer
Private long_cnt As Integer
Private short_cnt As Integer
...
Sub 찾기()
    ...
    Worksheets(Int(Rnd * 145) + 1).Activate
    ...
    If start_row = 0 Or end_row = 0 Then Call rotate
...
Sub cal()
    ...
    Do
        ...
        If Cells(i, 10).Value = "매수진입" Then
            ...
            Else
                ...
                arProfit(p) = Cells(i + j - 1, 5).Value / open_price - 1
                p = p + 1
        ...
        ElseIf Cells(i, 10).Value = "매도진입" Then
            ...
            Else
                ...
                arProfit(p) = open_price / Cells(i + j - 1, 5).Value - 1
                p = p + 1
            End If
    ...
    Debug.Print end_row, i
    
    For i = 1 To trade_cnt
        Sheet1.Cells(21 + page, i + 16).Value = arProfit(i)
    ...
    Dim ave As Double
        For i = 1 To trade_cnt
            ave = ave + arProfit(i)
        Next i
        Sheet1.Cells(21 + page, 4).Value = ave / trade_cnt
        
    Sheet1.Cells(21 + page, 3).Value = tot_Profit
    Sheet1.Cells(21 + page, 2).Value = Worksheets(p).Name
    
    Worksheets(1).Activate
    
    If page < page_cnt Then
        Call rotate
    End If
End Sub
